...
The first step in extending the Divi social media options, is to find andoverride the existing function that loads those options. That function is *et_load_core_options*, located in 'Divi/epanel/custom_functions.php'. That purpose of that function is to require another file 'Divi/epanel/options_divi.php'.
